...
def train_totals_model():
    ...
    # Define Target_Total = HomeScore + AwayScore
    ...
    for lmbda in lambdas:
        ...
        for fold_idx, (train_idx, val_idx) in enumerate(cv_splits):
            ...
            fold_stage2_clf.fit(train_fold_df[selected_full_features], y_tr_clf_s2, nested_splits, sample_weight=w_fold)
    ...
    stage2_clf.fit(train_val_df[selected_full_features], y_clf_train_val_s2, cv_splits, sample_weight=train_val_weights)
    ...
    stage2_clf.fit(X_refit_full, y_clf_refit_s2, cv_splits_refit, sample_weight=refit_weights)
